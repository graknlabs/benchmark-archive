...
import static grakn.core.graql.Graql.compute;
...
public class GraknGraphProperties implements GraphProperties {
    ...
    public Stream<Pair<Set<String>, Set<String>>> connectedEdgePairs(boolean edgeCardinalitesGreaterThanOne) {
        ...
        Stream<Pair<Set<String>, Set<String>>> edgePairs = query.stream().map(
                conceptMap -> {
    ...
    public Stream<Long> vertexDegree() {
        ...
        // so we don't have to execute it twice
        ...
        long numNonzeroDegrees = answerMap.stream().
