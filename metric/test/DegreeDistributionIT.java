...
public class DegreeDistributionIT {
    ...
    @Test
    public void standardBinaryGraphToPercentiles() {
        Path edgeListFilePath = Paths.get("/Users/joshua/Documents/benchmark/metric/test/binaryGraph.csv");
        // degree distribution: [1, 1, 1, 1, 1, 2, 2, 2, 3, 3]
        // compressed degree distribution [0th, 20th, 50th, 70th, 100th]: [1, 1, 2, 2, 3]

        StandardGraphProperties graphProperties = new StandardGraphProperties(edgeListFilePath.toFile());
        ...
        long[] correctDegreeDistribution = new long[] {1, 1, 2, 2, 3};
