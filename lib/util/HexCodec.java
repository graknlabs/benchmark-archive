 ...
 * replicated to reduce external dependencies
 */
public class HexCodec {

    // --- Borrowed from `brave.internal.HexCodec.toLowerHex` ---
    ...
    // --- Borrowed from `zipkin2.internal.HexCodec.lowerHexToUnsignedLong` to reduce external dependencies ---
